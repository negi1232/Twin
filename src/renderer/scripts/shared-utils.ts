/**
 * @module renderer/shared-utils
 * @description Renderer 用の共通ユーティリティ関数。
 * Main プロセスの shared/ モジュールと同等の実装を
 * ブラウザのグローバルスコープで提供する。
 */
...
if (typeof module !== 'undefined' && module.exports) {
  module.exports = { escapeHtml, classifyProperty, LAYOUT_PROPS, TEXT_PROPS, VISUAL_PROPS };
}
